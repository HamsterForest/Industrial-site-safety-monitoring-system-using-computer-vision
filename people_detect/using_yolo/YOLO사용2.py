...
# yolo 로드
net = cv2.dnn.readNet("weight_files_folder/yolov3_2/yolov3.weights", "weight_files_folder/yolov3_2/yolov3.cfg")
...
with open("weight_files_folder/yolov3_2/coco.names", "r") as f:#.namses => 알고리즘이 감지 할 수 있는 객체의 이름 모음
